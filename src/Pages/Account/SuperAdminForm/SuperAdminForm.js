...
export default function SuperAdminForm() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      const moduleData = await getAllSport(0);

      const dropdownOptions = moduleData.records.map(option => ({
        value: option._id,
        label: option.name
      }));
      console.log(dropdownOptions);
      setmoduleList(dropdownOptions)
    };
    fetchData();
  }, [id, getDetailByID]);
            ...
            <Card.Body>
              ...
              >
                ...
                <Row>
                  ...
                  <h4 className="mb-4">Super Admin Setting </h4>
