...
export const totalTransactions = {
  ...
  options: {
    ...
    colors: ["#6259ca", "#f99433", "#f99433", "#f99433", "#f99433"],
    dataLabels: {
      enabled: false
    },
    stroke: {
...
export const categoryWiseGraph = {
  options: {
    ...
    xaxis: {
      categories: ['Sports P/L', 'Casino P/L', 'Tp Casino P/L', 'Total P/L'],
      labels: {
        show: true,
        style: {
          colors: ['#000']
    ...
    colors: ['#556ee6', '#f1b44c', '#50a5f1', '#128412'] // Array of colors for each category
  },
  series: [
    {
      name: 'Series-1',
      data: [1500, 1200, 200, 1400],
    }
  ]
