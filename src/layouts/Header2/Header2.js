        ...
        <div className="d-flex align-items-center">
          ...
          <div className="responsive-logo">
            <Link to={`${process.env.PUBLIC_URL}/dashboard/`} className="header-logo">
              <img src={require("../../assets/images/brand/logo-3.png")} className="mobile-logo logo-1" alt="logo" />
              <img src={require("../../assets/images/brand/logo.png")} className="mobile-logo dark-logo-1" alt="logo" />
            </Link>
          </div>
            ...
            <div className="navbar navbar-collapse responsive-navbar p-0">
              <Navbar.Collapse className="navbar-collapse" id="navbarSupportedContent-4">
                <div className="d-flex order-lg-2">
                  ...
                  <div className="dropdown d-md-flex">
                    <Link to="#" className="nav-link icon full-screen-link nav-link-bg" onClick={Fullscreen}>
                  ...
                  <Dropdown className="d-md-flex notifications">
                    ...
                    <Dropdown.Menu className=" dropdown-menu-end dropdown-menu-arrow " style={{ margin: 0 }}>
                      ...
                      <div className="notifications-menu">
                        <Dropdown.Item className=" d-flex" href={`${process.env.PUBLIC_URL}/components/defaultChat/`}>
                      ...
                      <Link to="#" className=" dropdown-item text-center p-3 text-muted">
                        View all Notification
                      </Link>
                    </Dropdown.Menu>
                  </Dropdown>
                  <Dropdown className="dropdown d-md-flex message">
                    <Dropdown.Toggle className="nav-link icon text-center d-flex" variant="">
                      <i className="fe fe-message-square"></i>
                        ...
                        <Dropdown.Item className=" d-flex" href={`${process.env.PUBLIC_URL}/components/defaultChat/`}>
                          ...
                          <div className="wd-90p">
                            <div className="d-flex">
                              ...
                              <small className="text-muted ms-auto text-end">3 hours ago</small>
                            </div>
                        ...
                        <Dropdown.Item className=" d-flex" href={`${process.env.PUBLIC_URL}/components/defaultChat/`}>
                          ...
                          <div className="wd-90p">
                            <div className="d-flex">
                              ...
                              <small className="text-muted ms-auto text-end">5 hour ago</small>
                            </div>
                        ...
                        <Dropdown.Item className=" d-flex" href={`${process.env.PUBLIC_URL}/components/defaultChat/`}>
                          ...
                          <div className="wd-90p">
                            <div className="d-flex">
                              ...
                              <small className="text-muted ms-auto text-end">45 mintues ago</small>
                            </div>
                        ...
                        <Dropdown.Item className=" d-flex" href={`${process.env.PUBLIC_URL}/components/defaultChat/`}>
                          ...
                          <div className="wd-90p">
                            <div className="d-flex">
                              ...
                              <small className="text-muted ms-auto text-end">2 days ago</small>
                            </div>
                            <span>New Schedule Realease......</span>
                          </div>
                        </Dropdown.Item>
                  ...
                  <Dropdown className=" d-md-flex profile-1">
                    ...
                    <Dropdown.Menu className="dropdown-menu-end dropdown-menu-arrow" style={{ margin: 0 }}>
                      ...
                      <Dropdown.Item href={`${process.env.PUBLIC_URL}/pages/mailInbox/`}>
                      ...
                      <Dropdown.Item href={`${process.env.PUBLIC_URL}/pages/faqs/`}>
                        <i className="dropdown-icon fe fe-alert-triangle"></i>
                        Need help?p??
                      </Dropdown.Item>
                      <Dropdown.Item href={`${process.env.PUBLIC_URL}/custompages/login/`}>
                  ...
                  <div className="dropdown d-md-flex header-settings">
                    <Link to="#" className="nav-link icon " onClick={() => openCloseSidebarright()}>
